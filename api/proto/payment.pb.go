...
func (x *GetPaymentDetailResponse) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *GetPaymentDetailResponse) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
func file_api_proto_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_payment_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_proto_payment_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_proto_payment_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
